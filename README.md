...
| `$ARGON2_PARALLELISM`            | `2`                                                | The amount of threads to compute the Argon2 hash on. Each thread has a memory pool with memoryCost size. Note that changing it also changes the resulting hash.                              |
